...
class Inheritance_CylinderAreaSide extends CylinderArea
{
    double h;double areaside;
    
    Inheritance_CylinderAreaSide(double r,double ht)
    {
        super(r);
        h=ht;
    }
    ...
    static void main()
    {
        Inheritance_CylinderAreaSide ob=new Inheritance_CylinderAreaSide(3.0,5.0);
        ob.area();
        ob.show();
    }
}